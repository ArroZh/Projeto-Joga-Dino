...
caminho_dino = (os.path.join(CAMINHO_PASTA,".\\Automacao\\hipotenusa.png"))
...
while True:
    for foto in lista_fotos:
        ...
        try:
            ...
            posicao_dino = auto.locateOnScreen(caminho_dino, confidence=0.8)
            ...
            print("posição do cacto:",posicao_cacto.left)
            print("posição do dino:", posicao_dino.left)


            if posicao_cacto.left - posicao_dino.left <= 200:
                auto.press("space")
                auto.keyDown("space")
